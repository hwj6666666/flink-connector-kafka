...
package org.apache.flink.connector.kafka.dynamic.sink.config;
...
/** Connector options used by dynamic Kafka sink runtime. */
@Internal
public class DynamicKafkaSinkOptions {

    private DynamicKafkaSinkOptions() {}
    ...
    public static final ConfigOption<Long> STREAM_METADATA_DISCOVERY_INTERVAL_MS =
            ConfigOptions.key("stream-metadata-discovery-interval-ms")
                    ...
                    .defaultValue(-1L)
                    .withDescription(
                            "The interval in milliseconds for discovering changes in stream metadata. "
                                    + "A non-positive value disables metadata discovery.");
